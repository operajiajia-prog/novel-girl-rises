-- AlterTable
ALTER TABLE "Book" ADD COLUMN     "userNotes" TEXT;

-- AlterTable
ALTER TABLE "User" ADD COLUMN     "readerBgColor" TEXT,
ADD COLUMN     "readerFontSize" INTEGER,
ADD COLUMN     "readerLineHeight" TEXT;
